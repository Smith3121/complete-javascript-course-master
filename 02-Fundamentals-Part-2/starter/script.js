...
// 4.1. First, you will need to add up all values in the array. To do the addition, start by creating 
// a variable 'sum' that starts at 0. Then loop over the array using a for loop. In each iteration, add the current 
// value to the 'sum' variable. This way, by the end of the loop, you have all values added together.
...
storeTips(bills, tips, totals);

console.log(`The bills array is ${bills}, the tips array is ${tips}, and the totals array is ${totals}`);
