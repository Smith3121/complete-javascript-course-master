...
console.log(maskCreditCrad(4333342321343444334324243234))
console.log(maskCreditCrad('454532455466562555000493988292498276625344545')
);  
...
const planesInLine = function (n) {
  console.log(`There are ${n} planes in line ${'I'.repeat(n)}`);
}
